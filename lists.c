...
/**
 * print_list_str - only prints a list_t linked list's str element
 * @h: referee to the 1st node
 * Return: the list’s size
 */
...
/**
 * free_list - frees every node on a list.
