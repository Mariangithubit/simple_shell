...
/**
 * write_history - create a file | attach to a file already existing
 * @info: parameter of the structure
...
/**
 * read_history - reads the history from the existing file
 * @info: Parameter of the structure
 * Return: return 1 if successful if not return 0
 */
...
/**
 * renumber_history - renumbers the history list after the changeing
 * @info: Struct containing arguments that will use to
 *          maintain the const funct prototype.
